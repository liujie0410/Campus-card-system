...
static const char qt_meta_stringdata_MainWidget[] = {
    "MainWidget\0\0decID,byteID\0"
    "onNewCard(ulong,QByteArray)\0"
    "on_reconnectBtn_clicked()\0"
};
...
int MainWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: onNewCard((*reinterpret_cast< ulong(*)>(_a[1])),(*reinterpret_cast< const QByteArray(*)>(_a[2]))); break;
        case 1: on_reconnectBtn_clicked(); break;
        default: ;
        }
        _id -= 2;
    }
